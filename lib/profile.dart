                  ...
                  Padding(
                    ...
                    child: SizedBox(width: 130,height: 130,
                        child: ClipRRect(borderRadius: BorderRadius.circular(100),
                          child: CircleAvatar(backgroundImage: AssetImage("images/personal image.jpg"),),
                        )),
                  ),
                  Column(
                    children: [
                      ...
                      Column(
                        children: [
                          Text("Mishab Ms",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                          Text("mhdmishab000@gmail.com"),
